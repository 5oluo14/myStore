...
@section('form')
    ...
    {{ \App\Helper\Field::number(name: 'buying_price', label: 'سعر الشراء', required: 'true', placeholder: 'سعر الشراء', value: $record->price) }}
    {{ \App\Helper\Field::number(name: 'sellind_price', label: 'سعر البيع', required: 'true', placeholder: 'سعر البيع', value: $record->price) }}
